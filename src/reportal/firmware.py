...
SIGNATURES: tuple[Signature, ...] = (
    ...
    Signature("lz4", "LZ4 frame", b"\x04\x22\x4d\x18"),
    Signature("zstd", "zstd frame", b"\x28\xb5\x2f\xfd"),
    Signature("cpio", "cpio newc archive", b"070701"),
    Signature("dtb", "Flattened device tree", b"\xd0\x0d\xfe\xed"),
