...
ERROR_DOC_ANCHORS: dict[str, str] = {
    ...
    "corrupt-undo-plan": "corrupt-undo-plan",
    ...
    "invalid-kind": "invalid-kind",
    "invalid-limit": "invalid-limit",
    "invalid-similar-query": "invalid-similar-query",
    "invalid notification query": "invalid-notification-query",
    ...
    "unknown artifact kind": "unknown-artifact-kind",
    ...
    "path-outside-repo": "path-outside-repo",
