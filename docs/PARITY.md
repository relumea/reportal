...
reportal's own surface for the comparison is its FastAPI schema (204
paths, 285 operations) plus the MCP tool registry (222 tools).  Every row below is
