...
reportal's own surface for the comparison is its FastAPI schema (239
paths, 332 operations) plus the MCP tool registry (252 tools).  Every row below is
