...
paths, 261 operations) plus the MCP tool registry (201 tools).  Every row below is
...
`get_data_type_functions` MCP tools (201 tools: 93 read-only, 108 destructive);
